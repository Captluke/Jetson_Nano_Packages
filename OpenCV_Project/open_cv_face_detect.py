...
HAAR_CASCADE_XML_FILE_FACE = "/home/jlukas/Desktop/My_Project/Resource/haarcascade_frontalface_default.xml" 
...
GSTREAMER_PIPELINE = 'v4l2src device=/dev/video0 ! video/x-raw, width=640, height=480, framerate=30/1 ! videoconvert !  video/x-raw, , format=(string)BGR ! appsink'
